    ...
    <div class="row justify-content-center">
      ...
      <form class="user" @submit.prevent="employeeUpdate" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="form-row">
            <div class="col-md-6">
         <input type="text" class="form-control" v-bind="{value:form.name}"  id="exampleInputFirstName" placeholder="Enter Your Full Name" v-model="form.name">
     ...
     <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="form-row">
                ...
                <div class="col-md-1">
                    <img :src="'/'+form.photo" style="height: 40px; width: 40px;border-radius:50%">
                </div>
